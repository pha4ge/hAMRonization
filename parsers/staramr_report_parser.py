...
FIELD_MAP_STARAMR = {
    ...
    'end': 'stop',
    'gene': 'gene_symbol',
    'percent_overlap': 'coverage_percent',
...
def parse_report(path_to_report):
    ...
    with open(path_to_report) as report_file:
        ...
        float_fields = ['percent_identity', 'percent_overlap']
        for row in reader:
...
def prepare_for_amr_class(parsed_report, additional_fields={}):
    ...
    for field, amr_result_field in FIELD_MAP_STARAMR.items():
        if amr_result_field:
...
def main(args):
    ...
    additional_fields = {}
    additional_fields['analysis_software_name'] = "staramr"
...
if __name__ == '__main__':
    ...
    parser.add_argument("report", help="Input staramr resfinder.tsv report")
