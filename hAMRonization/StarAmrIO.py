        ...
        for result in reader:
            ...
            if 'Mutation' in result:
                ...
                if result['Type'] == 'nucleotide':
                    ...
                    result['_nucleotide_mutation'] = f"n.{result['Position']}{ref}>{alt}"
                    ...
                    result['_nucleotide_mutation'] = f"n.{result['Position']}{nuc_ref}>{nuc_alt}"
                    result['_amino_acid_mutation'] = f"p.{aa_ref}{result['Position']}{aa_alt}"
                else:
                    assert False
