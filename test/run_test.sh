...
hamronize resfinder --input_file_name resfinder4_report --analysis_software_version resfinder_v4 --reference_database_version resfinder_db_v1 data/raw_outputs/resfinder4/ResFinder_results_tab.txt --format json --output hamronized_resfinder4.json
hamronize resfinder --input_file_name resfinder4_report --analysis_software_version resfinder_v4 --reference_database_version resfinder_db_v1 data/raw_outputs/resfinder4/ResFinder_results_tab.txt --format tsv --output hamronized_resfinder4.tsv
